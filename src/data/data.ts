...
export const projects: ProjectProps[] = [
  {
    title: "Sushi boom",
    demoUrl: "",
    githubUrl: "https://github.com/NatKhomich/Sushi-boom",
    image: sushi,
    description: `
A full-stack web application for ordering sushi rolls. The app includes user authentication and registration, product browsing, cart management, and payment functionality. Currently under active development.
        `,
    technologies: [
      "Next.js",
      "Zustand",
